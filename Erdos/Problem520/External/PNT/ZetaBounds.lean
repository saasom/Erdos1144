import Erdos.Problem520.External.Architect
import Batteries.Tactic.Lemma
import Mathlib.MeasureTheory.Function.Floor
import Mathlib.MeasureTheory.Order.Group.Lattice
import Mathlib.NumberTheory.Harmonic.Bounds
import Mathlib.NumberTheory.LSeries.Nonvanishing
import Erdos.Problem520.External.PNT.Auxiliary
import Erdos.Problem520.External.PNT.Fourier
import Erdos.Problem520.External.PNT.Mathlib.Analysis.SpecialFunctions.Log.Basic
import Erdos.Problem520.External.PNT.ResidueCalcOnRectangles
...
lemma ZetaSum_aux1φDiff {s : ℂ} {x : ℝ} (xpos : 0 < x) :
  ...
  exact hasDerivAt_deriv_iff.mpr <| DifferentiableAt.div
    (differentiableAt_const _)
    (Real.differentiableAt_cpow_const_of_ne s xpos)
    (by simp [cpow_eq_zero_iff, xpos.ne'])
